...
const StatsSection: React.FC = () => {
  const stats = [
    ...
    { label: "Fournitures récoltées", value: 75, target: 100, unit: "kg" },
    { label: "Enfants aidés", value: 120, target: 150, unit: "" },
    { label: "Préparation 4L Trophy 2025", value: 65, target: 100, unit: "%" },
  ];
